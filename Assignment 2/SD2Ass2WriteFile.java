...
public class SD2Ass2WriteFile extends JFrame implements ActionListener
{
	...
	public SD2Ass2WriteFile() //contructor -- initalises the Frame
	{
	...
	public void addRecord() //create method for adding records to file
	{
		...
		if ( ! idField.getText().equals( "" ) );
		{
			try
			{
				...
				{
					JOptionPane.showMessageDialog(this, "Employee ID must be between 1 & 100");
				}
				...
				else if (accId > 0 && accId <= 100 )
				{
					...
					{
						JOptionPane.showMessageDialog(this,"ID already exists! Please try a different employee ID");
