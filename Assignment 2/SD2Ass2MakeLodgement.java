...
public class SD2Ass2MakeLodgement extends JFrame implements ActionListener
{
	...
	public SD2Ass2MakeLodgement() //constructor
	{
		...
		lodgeBut = new JButton( "Make Lodgement");
	...
	public void actionPerformed( ActionEvent e )
	{
		...
		if (e.getSource() == lodgeBut)
		{
			try
			{
				...
				lodgement = Integer.parseInt(JOptionPane.showInputDialog("Enter Lodgement Ammount"));

				if (lodgement <= 0)
				{
					JOptionPane.showMessageDialog(this, "Invalid Lodgement Request");
				}

				else
				{
					data.setBalance( data.getBalance() + lodgement);

					output.seek( (long) ( accId-1 ) * SD2Ass2Record.size() );
					data.write( output );

					JOptionPane.showMessageDialog(this, lodgement + " €  succesfully lodged into " + data.getFirstName() + " " + data.getLastName() + " account");
					idField.setText("");
